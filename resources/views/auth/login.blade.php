...
<head>
    ...
    <style>
        ...
        :root {
            ...
            --shadow-sm: 0 4px 14px rgba(13, 27, 22, 0.06);
            --shadow-md: 0 14px 34px rgba(13, 27, 22, 0.12);
            --shadow-lg: 0 24px 60px rgba(7, 61, 39, 0.35);
        }
    ...
    <div class="auth-wrapper">
        ...
        <div class="auth-aside">
            ...
            <div class="aside-copy">
                ...
                <h1>Masuk untuk melihat <em>progres terbaru</em> madrasah Anda.</h1>
                <p>Semua data akademik, non-akademik, dan keagamaan sudah menunggu di dashboard Anda.</p>
            </div>
