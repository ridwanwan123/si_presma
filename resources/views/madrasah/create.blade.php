                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="jenjang_madrasah"
                                ...
                                <option value="RA" {{ old('jenjang_madrasah') == 'RA' ? 'selected' : '' }}>
                                    RA
                                </option>

                                <option value="MI" {{ old('jenjang_madrasah') == 'MI' ? 'selected' : '' }}>
                                    MI
                                </option>

                                <option value="MTs" {{ old('jenjang_madrasah') == 'MTs' ? 'selected' : '' }}>
                                    MTs
                                </option>

                                <option value="MA" {{ old('jenjang_madrasah') == 'MA' ? 'selected' : '' }}>
                                    MA
                                </option>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="npsn" value="{{ old('npsn') }}" maxlength="8"
                                class="form-control @error('npsn') is-invalid @enderror" placeholder="Nomor NPSN">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="akreditasi" class="form-select @error('akreditasi') is-invalid @enderror">
                                ...
                                <option value="A" {{ old('akreditasi') == 'A' ? 'selected' : '' }}>
                                    A
                                </option>

                                <option value="B" {{ old('akreditasi') == 'B' ? 'selected' : '' }}>
                                    B
                                </option>

                                <option value="C" {{ old('akreditasi') == 'C' ? 'selected' : '' }}>
                                    C
                                </option>

                                <option value="belum_diakreditasi"
                                    {{ old('akreditasi') == 'belum_diakreditasi' ? 'selected' : '' }}>
                                    Belum Diakreditasi
                                </option>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="kota" class="form-select @error('kota') is-invalid @enderror">
                                ...
                                <option value="Jakarta Timur" {{ old('kota') == 'Jakarta Timur' ? 'selected' : '' }}>
                                    Jakarta Timur
                                </option>

                                <option value="Jakarta Barat" {{ old('kota') == 'Jakarta Barat' ? 'selected' : '' }}>
                                    Jakarta Barat
                                </option>

                                <option value="Jakarta Selatan" {{ old('kota') == 'Jakarta Selatan' ? 'selected' : '' }}>
                                    Jakarta Selatan
                                </option>

                                <option value="Jakarta Utara" {{ old('kota') == 'Jakarta Utara' ? 'selected' : '' }}>
                                    Jakarta Utara
                                </option>

                                <option value="Jakarta Pusat" {{ old('kota') == 'Jakarta Pusat' ? 'selected' : '' }}>
                                    Jakarta Pusat
                                </option>

                                <option value="Kepulauan Seribu" {{ old('kota') == 'Kepulauan Seribu' ? 'selected' : '' }}>
                                    Kepulauan Seribu
                                </option>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="provinsi" value="DKI Jakarta" readonly
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="nama_kepala_madrasah" value="{{ old('nama_kepala_madrasah') }}"
                                class="form-control @error('nama_kepala_madrasah') is-invalid @enderror"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="nip_kepala_madrasah" value="{{ old('nip_kepala_madrasah') }}"
                                maxlength="18" pattern="[0-9]{18}" oninput="this.value=this.value.replace(/[^0-9]/g,'')"
                                class="form-control @error('nip_kepala_madrasah') is-invalid @enderror"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="nama_kepala_urusan_tata_usaha"
                                value="{{ old('nama_kepala_urusan_tata_usaha') }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="nip_kepala_urusan_tata_usaha"
                                value="{{ old('nip_kepala_urusan_tata_usaha') }}" maxlength="18" pattern="[0-9]{18}"
